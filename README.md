...
dependencies {
    compile 'com.github.mkopylec:charon-spring-boot-starter:1.5.0'
}
```
...
Mappings can also be updated at anytime by injecting a `MappingsProvider` Spring bean and invoking `MappingsProvider.updateMappings()` method.
