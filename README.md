...
- if there are mappings like _/uri_ and _/uri/path_ and the incoming request URI is _/uri/path/_something the more specific mapping (_/uri/path_) will be chose
